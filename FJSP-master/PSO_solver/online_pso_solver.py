"""
Online PSO Solver — 符合 SkyEngine JobSolver 接口的在线调度器

流程:
  1. 首次 plan(obs) 被调用时:
     - 从 obs 提取问题参数
     - 调用 PSOSolver 离线求解，生成完整调度方案
...
class OnlinePSOSolver:
    ...
    def _solve_offline(self, obs):
        ...
        # 构建 PSOSolver 并求解
        solver = PSOSolver(data, n_jobs, n_ops, n_machines,
        ...
        print(f"[OnlinePSO] 离线求解完成, makespan={best_makespan:.0f}, "
